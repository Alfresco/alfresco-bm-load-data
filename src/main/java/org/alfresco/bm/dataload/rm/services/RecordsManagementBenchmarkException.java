...
public class RecordsManagementBenchmarkException extends Exception
{
     ...
     *
     * @param cause (Throwable, optional) the cause.
     */
     ...
     * @param message            (String) the detail message.
     * @param cause              (Throwable, optional) the cause.
     * @param enableSuppression  (boolean) indicates whether or not suppression is enabled or disabled
     * @param writableStackTrace (boolean) indicates whether or not the stack trace should be writable
     */
    public RecordsManagementBenchmarkException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace)
    {
     ...
     *
     * @param objectIdentifier (String, will be validated) object name or identifier
     * @throws RecordsManagementBenchmarkException
     */
    public static void throwNewObjectNotFoundException(String objectIdentifier) throws RecordsManagementBenchmarkException
    {
