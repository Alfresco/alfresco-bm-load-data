...
public interface RecordsManagementDataService
{
     ...
     *
     * @param filePlanName (String) name of the file plan to retrieve.
     * @return (FilePlanData) file plan by it's unique name.
     * @throws RecordsManagementBenchmarkException if file plan not available or error
     */
     ...
     * @throws RecordsManagementBenchmarkException if no default file plan available or error
     */
     ...
     * @throws RecordsManagementBenchmarkException if no file plan available or error
     */
     ...
     * Adds a file plan.
     *
     * @param data (FilePlanData, required) file plan to add.
     */
     ...
     *
     * @param creationState (DataCreationState, optional) creation state, if null number of all file plans will be returned.
     ...
     *
     * @param creationState (DataCreationState, optional) creation state, if null all file plans will be returned.
     ...
     *
     * @param categoryName (String) name of the record category to retrieve.
     * @return (RecordCategoryData) the record category in a file plan by name.
     * @throws RecordsManagementBenchmarkException if record category not available or error
     */
     ...
     * @throws RecordsManagementBenchmarkException if no record category available or error
     */
     ...
     *
     * @param recordCategory (RecordCategoryData, required) record category to add.
     */
     ...
     *
     * @param creationState (DataCreationState, required) creation state.
     ...
     *
     * @param creationState (DataCreationState, optional) data creation state or null to return all record categories.
